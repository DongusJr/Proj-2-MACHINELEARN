...
import static base.Base.*;    // Definition for default MAIN_CONFIG
...
public class ModelConfig extends Stage implements Initializable
{
  ...
  @FXML public  TextField configFile;
  @FXML public  TextField exportDir;
  ...
  public ModelConfig()
  {
    ...
    // values set for choice box in resources/modelconfig.fxml
  ...
  public void initialize(URL url, ResourceBundle resourceBundle)
  {
    if (config != null)
    {
      ...
      exportDir.setText(config.getLastExportDir());
      if (simconfig != null)
      {
