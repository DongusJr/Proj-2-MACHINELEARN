...
public class GovtConfig extends Stage implements Initializable
{
  ...
  @FXML private CheckBox  ubi;
  @FXML private TextField dolePayment;
  @FXML private TextField ubiPayment;
  ...
  public GovtConfig(Govt govt)
  {
    ...
    try
    {
      ...
      ubi.setSelected(govt.payUBI);
      ubiPayment.setText(Integer.toString(govt.ubiPayment));
    }
    catch (IOException e)
    {
      e.printStackTrace();
  ...
  @FXML void onOkButton(ActionEvent event)
  {
    ...
    govt.payUBI              = ubi.isSelected();
    govt.ubiPayment          = Integer.parseInt(ubiPayment.getText());
