...
public class Farm extends Company
{
   ...
   *                       product        Product farm is producing 
   *                       initialDeposit initial deposit with bank 
   *                       labourInput amount of labour(employees) to produce
   *                       a unit of product
   */
  ...
  public void evaluate(boolean report, int step)
  {
   ...
   else if (s_income.shrinking(2))
   {
    ...
    //after taxes, pay out dividend to owner
    payDividendToOwner();
