...
public class MyStockInvestor extends StockInvestor
{
  @Expose
  ...
  public MyStockInvestor(String name, Govt g, Bank b, HashMap<String, String> properties)
  {
